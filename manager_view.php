...
<div class="card">
    <div class="card-header text-center" style="font-family: Sans-Serif; text-transform:uppercase; font-size:1.5rem">
        ...
        <a href="monthly_transaction.php" class="btn btn-primary">Monthly Transaction</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
        <br></br>
        <form action="daterange_transaction.php" method="POST">
            <label for="start">Date Range:</label>

            <input type="datetime" id="start" name="trip-start" min="2001-01-01" max="2024-12-31">
            <label for="start">To</label>
            <input type="datetime" id="start" name="trip-end" min="2001-01-01" max="2024-12-31">
