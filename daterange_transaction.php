...
if (!empty($_POST["submit"])) {
    ...
    $end = $_POST["trip-end"];
    $userNFTS = $member->getDateRange($start, $end);
}
...
<div class="card">
    <div class="card-header text-center" style="font-family: Sans-Serif; text-transform:uppercase; font-size:1.5rem">
        ...
        <br></br>
        <form action="daterange_transaction.php" method="POST">
            <label for="start">Date Range:</label>
            <input type="datetime" id="start" value=' . $start . ' name="trip-start" min="2001-01-01" max="2024-12-31">
            <label for="start">To</label>
            <input type="datetime" id="start" value=' . $end . ' name="trip-end" min="2001-01-01" max="2024-12-31">
            <input type="submit" name="submit" class="btn btn-primary"></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
        </form>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Daily Transaction History</h4>
                                    </div>
